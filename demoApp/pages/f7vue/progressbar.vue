<template>
  <f7-page>
    ...
    <div class="block">
      <p>In addition to <a href="/f7vue/preloader/">Preloader</a>, Framework7 also comes with fancy animated determinate and infinite/indeterminate progress bars to indicate some activity.</p>
    </div>
